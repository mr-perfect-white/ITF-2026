<!-- Footer Section Start -->
                        ...
                        <div class="footer-widget-items">
                            ...
                            <div class="footer-content text-white fw-bold">
                                ...
                                <div class="social-icon">
                                    <a href="https://www.facebook.com/MilletsOrganics" class="text-white"><i class="fab fa-facebook-f"></i></a>
                                    <a href="https://x.com/organicmillets" class="text-white"><i class="fab fa-twitter"></i></a>
                                    <a href="https://www.youtube.com/@organicmilletsitf" class="text-white"> <i class="fab fa-youtube"></i></a>
                                    <a href="https://www.instagram.com/organicsmillets2023/" class="text-white"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="contact-list">
                                <li>
                                    ...
                                    <div class="content">
                                        ...
                                        <p><a href="mailto:kssc.manager.acct@gmail.com" class="text-white">kssc.manager.acct@gmail.com</a></p>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        ...
                                        <p><a href="tel:+ 080-22271194 / 22243082" class="text-white"> 080-22271194 / 22243082</a></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="footer-widget-items">
                            ...
                            <ul class="contact-list">
                                <li>
                                    ...
                                    <div class="content">
                                        <h5  class="text-white"><?= $MSG['foot_email_us']; ?>:</h5>
                                        <p><a href="mailto:kssc.manager.acct@gmail.com" class="text-white">organiccell@gmail.com</a></p>
                                    </div>
                                </li>
                                <li>
    ...
    <!--<< All JS Plugins >>-->
    <script src="../ITF/frontend/js/jquery-3.7.1.min.js"></script>
    <!--<< Bootstrap Js >>-->
    <script src="../ITF/frontend/js/bootstrap.bundle.min.js"></script>
    <!--<< Nice Select Js >>-->
    <script src="../ITF/frontend/js/jquery.nice-select.min.js"></script>
    <!--<< Odometer Js >>-->
    <script src="../ITF/frontend/js/odometer.min.js"></script>
    <!--<< Appear Js >>-->
    <script src="../ITF/frontend/js/jquery.appear.min.js"></script>
    <!--<< Swiper Slider Js >>-->
    <script src="../ITF/frontend/js/swiper-bundle.min.js"></script>
    <!--<< MeanMenu Js >>-->
    <script src="../ITF/frontend/js/jquery.meanmenu.min.js"></script>
    <!--<< Magnific Popup Js >>-->
    <script src="../ITF/frontend/js/jquery.magnific-popup.min.js"></script>
    <!--<< Wow Animation Js >>-->
    <script src="../ITF/frontend/js/wow.min.js"></script>
    <!--<< Gsap Animation Js >>-->
    <script src="../ITF/frontend/js/gsap.min.js"></script>
    <!--<< ScrollTrigger Js >>-->
    <script src="../ITF/frontend/js/ScrollTrigger.min.js"></script>
    <!--<< SplitText Js >>-->
    <script src="../ITF/frontend/js/SplitText.min.js"></script>
    <!--<< splitType Js >>-->
    <script src="../ITF/frontend/js/splitType.js"></script>
    <!--<< Main.js >>-->
    <script src="../ITF/frontend/js/main.js"></script>
</body>
