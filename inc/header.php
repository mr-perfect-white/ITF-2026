...
<html lang="en">
    ...
    <head>
        ...
        <!--<< Favicon >>-->
        <link rel="shortcut icon" href="http://mcwaredemo.in/ITF/frontend/img/favicon.svg">
        <!--<< Bootstrap min.css >>-->
        <link rel="stylesheet" href="http://mcwaredemo.in/ITF/frontend/css/bootstrap.min.css">
        <!--<< Font Awesome.css >>-->
        <link rel="stylesheet" href="http://mcwaredemo.in/ITF/frontend/css/font-awesome.css">
        <!--<< Animate.css >>-->
        <link rel="stylesheet" href="http://mcwaredemo.in/ITF/frontend/css/animate.css">
        <!--<< Magnific Popup.css >>-->
        <link rel="stylesheet" href="http://mcwaredemo.in/ITF/frontend/css/magnific-popup.css">
        <!--<< MeanMenu.css >>-->
        <link rel="stylesheet" href="http://mcwaredemo.in/ITF/frontend/css/meanmenu.css">
        <!--<< Odometer.css >>-->
        <link rel="stylesheet" href="http://mcwaredemo.in/ITF/frontend/css/odometer.css">
        <!--<< Swiper Bundle.css >>-->
        <link rel="stylesheet" href="http://mcwaredemo.in/ITF/frontend/css/swiper-bundle.min.css">
        <!--<< Nice Select.css >>-->
        <link rel="stylesheet" href="http://mcwaredemo.in/ITF/frontend/css/nice-select.css">
        <!--<< Main.css >>-->
        <link rel="stylesheet" href="http://mcwaredemo.in/ITF/frontend/css/main.css">
    </head>
    <body>
                <!-- Preloader Start -->
